...
// http://localhost:8080/_002_RESTfulRESTEasy/rest/merkez
@Path(value = "/merkez")
public class Merkez {
...
//	
	...
	// http://localhost:8080/_002_RESTfulRESTEasy/rest/merkez/sorgu1
	@GET
	@Path(value = "/sorgu1")
	...
	// http://localhost:8080/_002_RESTfulRESTEasy/rest/merkez/sorgu2
	@GET
	@Path(value = "/sorgu2")
	...
	// http://localhost:8080/_002_RESTfulRESTEasy/rest/merkez/sorgu3
	@GET
	@Path(value = "/sorgu3")
	@Produces("text/html")
	...
	// http://localhost:8080/_002_RESTfulRESTEasy/rest/merkez/sorgu4/{benimParametrem}
	@GET
